...
public class Data {
   ...
   private static Data [] Addition_Subjects_name ;
...
public static Data [] getAddition_Subjects_name() {
  String data [] = {"1 : Web Programming" , "2 : Critical Thinking" , "3 : Communications Skill" , "4 : Man and Environment" , "5 : Self Managment"};

  for (int i = 0 ; i<data.length;++i)

  { System.out.println(data[i]);}

  return Addition_Subjects_name;}
