...
public class All_G8_Students extends Data {
    ...
    String X4 [] = {"Web Programming" , "Critical Thinking" , "Communications Skill" , "Man and Environment" , "Self Managment"};
    ...
    void Check_Id_All_G8 () { 
        ...
        try {
          ...
          System.out.println("Enter The Id To Chec");
    ...
    void Addition_Subjects_name () {

      try {
        System.out.println("Do You want to add more Subjects ?  press 1 ==>Yes - 2 ==>No");
        int y4 = input.nextInt();

        switch (y4) {
          case 1: {
            Data.getAddition_Subjects_name();
            System.out.println();
            System.out.println("Choose your subject : (Only number beside)");
            int y5 = input.nextInt();

            switch (y5) {
              case 1: {
              System.out.println(X4[0] + " is Added");
              System.out.println();
              System.out.println("Your Subjects :");
              Data.getSubjects_Name();
              System.out.println(X4[0] + (" Added"));
              }
                break;
                case 2 : {
                  System.out.println(X4[1] + " is Added");
                  System.out.println();
                  System.out.println("Your Subjects :");
                  Data.getSubjects_Name();
                  System.out.println(X4[1] + (" Added"));
                }

                break;
                case 3 : {
                  System.out.println(X4[2] + " is Added");
                  System.out.println();
                  System.out.println("Your Subjects :");
                  Data.getSubjects_Name();
                  System.out.println(X4[2] + (" Added"));
                }

                break ;
                case 4 : {
                  System.out.println(X4[3] + " is Added");
                  System.out.println();
                  System.out.println("Your Subjects :");
                  Data.getSubjects_Name();
                  System.out.println(X4[3] + (" Added"));
                }

                break ;
                case 5 : {
                  System.out.println(X4[4] + " is Added");
                  System.out.println();
                  System.out.println("Your Subjects :");
                  Data.getSubjects_Name();
                  System.out.println(X4[4] + (" Added"));
                }
                break;
            }
          } break;
          case 2 : {System.out.println("No Subjects have been Added !");}
        }
